...
//        return anular.equals(this.actual, expected);
//      }
//    });
//  });
//
...
//      expect(scope.orderProp).toBe('ae');
//    });
//  });
//
//
...
//      $httpBackend.expectGET('phones/xyz.json').respond({name:'phone xyz', imaes: ['http://foo']});
//      ctrl = $controller(PhoneDetailCtrl, {$scope: scope});
//
//      expect(scope.phone).toEqualData({});
//      $httpBackend.flush();
//
//      expect(scope.phone).toEqualData({name:'phone xyz', imaes: ['http://foo']});
//    }));
//  });
  describe('PhoneListCtrl', function(){
//
